                                   ...
                                   <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                             ...
                                             <div>
                                                  ...
                                                  <button type="button" class="btn btn-sm btn-outline-light active text-white">1Y</button>
                                             </div>
                                        </div> <!-- end card-title-->
                                        ...
                                        <table class="table mb-0">
                                             ...
                                             <tbody>
                                                  <tr>
                                                       ...
                                                       <td>29 April 2024</td>
                                                       <td>
                                                            <img src="{{ asset('images/products/product-1(1).png')}}" alt="product-1(1)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="{{ asset('images/products/product-4.png')}}" alt="product-4" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="{{ asset('images/products/product-5.png')}}" alt="product-5" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>21 April 2024</td>
                                                       <td>
                                                            <img src="{{ asset('images/products/product-6.png')}}" alt="product-6" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>18 April 2024</td>
                                                       <td>
                                                            <img src="{{ asset('images/products/product-1(2).png')}}" alt="product-1(2)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
